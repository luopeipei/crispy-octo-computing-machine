...
/**
 * Created by SoleilLun on 2015/12/30.
 */
public class DataBaseProvider extends ContentProvider{
    ...
    public static final String AUTHORITY = "com.test.jsondemo.provider";
...
// 删除数据
    ...
    public String getType(Uri uri) {
        switch (uriMatcher.match(uri)) {
            case BOOK_DIR:
                return "vnd.android.cursor.dir/vnd.com.test.jsondemo.provider.book";
            case BOOK_ITEM:
                return "vnd.android.cursor.item/vnd.com.test.jsondemo.provider.book";
            case CATEGORY_DIR:
                return "vnd.android.cursor.dir/vnd.com.test.jsondemo.provider.category";
            case CATEGORY_ITEM:
                return "vnd.android.cursor.item/vnd.com.test.jsondemo.provider.category";
        }
        return null;
    }
}
